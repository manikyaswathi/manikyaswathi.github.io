...
\title{AI-Driven Resource Optimization for High-Performance Computing: A Comprehensive Framework }
\authordegrees{M.S.}  % Degrees thus far, not including this one.
\unit{Department of Computer Science and Engineering}

\advisorname{Rajiv Ramnath}
\member{Byna Suren}
\member{Subramoni Hari}
\member{Panda Dhabaleswar} 
...
\include{ch3.background}
\include{ch4.OverviewSolution}
% \include{ch5.CIDatabase}    % what is your solution
\include{ch6.GenerateData}       % conclusion stuff
\include{ch7.EstimationMetrics}
\include{Ch8.UseCase}
\include{ch9.FutureWork}
